...
export default class SubtractMatrices extends Component {
  static contextType = OperationContext;

  subtractMatrices() {
    console.log('Subtracting Matrices');
    const { showSteps, execute } = this.context;
    ...
    if (!allEqual(matrices)) {
      return (
        <p key={0}>Invalid Operation. To subtract matrices they must be the same dimension.</p>
      );
    }
